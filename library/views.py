...
def analyze_topics_process(request):
    ...
    analysis_content += "Identify common themes, concepts, and approaches across these standards.\n"
    ...
    analysis_content += "Explain how these standards differ in their treatment, emphasis, or approach to this topic.\n"
    ...
    analysis_content += "Highlight unique elements or perspectives that each standard brings.\n"
